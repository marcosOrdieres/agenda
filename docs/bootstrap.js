...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "NotesApp.controller.HeaderC": [],
  "NotesApp.controller.login.LoginC": [],
  "NotesApp.controller.peticiones.PeticionesDetalleC": [],
  "NotesApp.controller.peticiones.PeticionesListadoC": [],
  "NotesApp.store.peticiones.PeticionesS": [],
  "NotesApp.view.HeaderV": [],
  "NotesApp.view.UserOptionsPopup": [],
  "NotesApp.view.login.LoginV": [],
  "NotesApp.view.peticiones.PeticionesDetalleV": [],
  "NotesApp.view.peticiones.PeticionesListadoV": []
});
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "NotesApp.view.UserOptionsPopup": [
    "widget.useroptionspopup"
  ],
  "NotesApp.view.login.LoginV": [
    "widget.login"
  ],
  "NotesApp.view.peticiones.PeticionesDetalleV": [
    "widget.peticionesDetalleV"
  ],
  "NotesApp.view.peticiones.PeticionesListadoV": [
    "widget.peticionesListadoV"
  ]
});
